...
const BureauMembers: React.FC = () => {
  ...
  const members: Member[] = [
    ...
    },
    {
      ...
      photo: "/assets/membre-bureau/seyedina-mouhamadou-al-hamine-ndiaye.jpg",
    ...
    {
      id: 14,
      name: "Mouhamad Sagnane Ndiaye",
      role: "Sports",
      department: "Commission Sports",
      photo: "/assets/membre-bureau/mouhamad-sagnane-ndiaye.jpeg",
      bio: "Responsable Commission Sports, étudiant en M2 RS. Organise les activités et événements sportifs du club.",
      email: "events@clubinfo.uasz.sn",
      color: "from-indigo-500 to-purple-500",
      icon: Sparkles,
    },
    ...
    },
    {
      ...
      photo: "/assets/membre-bureau/halimatou-balde.jpeg",
    ...
    },
    {
      ...
      department: "Commission Événementielle",
      photo: "/assets/membre-bureau/djibi-fall.jpeg",
