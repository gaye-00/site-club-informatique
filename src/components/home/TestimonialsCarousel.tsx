  ...
  const testimonials: Testimonial[] = [
    {
      ...
      message:
        "Le Club Informatique m'a permis de passer de débutant à développeur professionnel en seulement 1 an. Les mentors sont incroyables et les projets réels m'ont donné une expérience inestimable.",
      avatar: "https://i.pravatar.cc/150?img=12",
      rating: 5,
      achievement: "Hackathon Winner 2024",
    ...
    },
    {
      ...
      role: "Data Scientist",
      message:
        "Grâce aux workshops sur l'IA et le Machine Learning, j'ai découvert ma passion pour la data science. Aujourd'hui, je travaille sur des projets d'analyse de données pour des entreprises internationales.",
      avatar: "https://i.pravatar.cc/150?img=5",
      rating: 5,
      achievement: "AI Challenge Champion",
    ...
    },
    {
      ...
      message:
        "Le Startup Weekend organisé par le club a été le déclic pour lancer ma propre startup. Nous avons levé 50 millions FCFA grâce aux connexions et aux compétences acquises ici.",
    ...
    },
    {
      ...
      role: "UX/UI Designer",
      message:
        "Les formations en design et développement front-end m'ont ouvert les portes du monde créatif. Je conçois maintenant des interfaces pour des clients partout en Afrique.",
    ...
    },
    {
      ...
      message:
        "Les projets collaboratifs m'ont appris à travailler en équipe et à maîtriser Git, Docker et Kubernetes. Ces compétences sont aujourd'hui essentielles dans mon travail quotidien.",
    ...
    },
    {
      ...
      message:
        "J'ai appris à créer des applications mobiles performantes grâce aux ateliers React Native. Ma première app a dépassé 10 000 téléchargements en 3 mois !",
      avatar: "https://i.pravatar.cc/150?img=10",
      rating: 5,
      achievement: "App Launch Success",
    ...
    },
    {
      ...
      message:
        "Les sessions sur la sécurité informatique ont changé ma vision du développement. Je suis maintenant consultant en cybersécurité pour plusieurs entreprises sénégalaises.",
      avatar: "https://i.pravatar.cc/150?img=51",
      rating: 5,
      achievement: "Security Specialist",
    ...
    },
    {
      ...
      message:
        "Le club m'a aidée à développer une vision produit solide. Les compétences techniques combinées au management m'ont permis de diriger des équipes tech avec succès.",
